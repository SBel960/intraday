...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["exchanges", 0, "trading_days_per_year"], 0, "trading_days_per_year"),
        (["archives", "download_workers"], 0, r"download_workers doit être dans \[1, 32\]"),
        (["archives", "download_workers"], 33, "download_workers"),
